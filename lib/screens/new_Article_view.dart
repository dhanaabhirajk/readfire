...
import 'package:readfire/resources/Firestore_methods.dart';
...
class _ArticleViewState extends State<ArticleView> {
  ...
  Article? _article;
  Article get getArticle => _article!;

  Future<void> get_article() async {
    Article article = await _firestoreMethods.getArticle(widget.article_id);
    _article = article;
  }
